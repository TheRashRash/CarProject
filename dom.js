//Read Garage(READ) field
export const readGarages = document.getElementById(`readGarages`);
//Create Garage(POST) field
...
//Delete
export const DelGarageID = document.getElementById(`DelGarage`)
